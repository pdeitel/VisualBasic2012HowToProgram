' Fig. 6.4: WageCalculator.vb
' Calculating an employee's pay using a function that returns a value.
Public Class WageCalculator
   Const HOURS_IN_A_WEEK As Integer = 168 ' total hours in one week
   ...
   Private Sub calculateButton_Click(sender As Object,
      ...
      If hoursWorked <= HOURS_IN_A_WEEK Then
         ' call CalculatePay Function
         Dim totalPay As Decimal = CalculatePay(hoursWorked, hourlywage)
         resultLabel.Text = String.Format("{0:C}", totalPay)
      Else
   ...
   Function CalculatePay(hours As Double, wages As Decimal) As Decimal
      ...
      Return earnings ' returns the total earnings back to the caller
   End Function ' CalculatePay
