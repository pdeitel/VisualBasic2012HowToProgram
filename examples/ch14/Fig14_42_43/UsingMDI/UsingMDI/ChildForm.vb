' Fig. 14.43: ChildForm.vb
' Child window of MDI parent.
Public Class ChildForm
   Public Sub New(title As String, fileName As String)
      ' ensure that Designer generated code executes
      InitializeComponent()
      ...
      displayPictureBox.Image = CType(pictureResource, Image)
   End Sub ' New
End Class ' ChildForm
